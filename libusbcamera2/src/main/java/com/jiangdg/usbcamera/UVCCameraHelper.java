...
public class UVCCameraHelper {
    ...
    private UVCCameraHelper(int format) {
        this.setDefaultFrameFormat(format);
    }
    ...
    public static UVCCameraHelper getInstance(int format) {
        if (mCameraHelper == null) {
            mCameraHelper = new UVCCameraHelper();
        }
        return mCameraHelper;
    ...
    public void requestPermission(int index) {
        System.out.println("requestPermission方法");
        List<UsbDevice> devList = getUsbDeviceList();
        System.out.println("getUsbDeviceList()");
        if (devList == null || devList.size() == 0) {
            System.out.println("devList == null");
            return;
        }
        ...
        if (mUSBMonitor != null) {
            System.out.println("mUSBMonitor.requestPermission start");
