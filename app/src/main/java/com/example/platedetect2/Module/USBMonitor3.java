...
//
//public final class USBMonitor3 {
//
//
//    private static final boolean DEBUG = true;	// TODO set false on production
//    private static final String TAG = "USBMonitor3";
//
...
//     */
//    private final ConcurrentHashMap<UsbDevice, USBMonitor3.UsbControlBlock> mCtrlBlocks = new ConcurrentHashMap<UsbDevice, USBMonitor3.UsbControlBlock>();
...
//    private final USBMonitor3.OnDeviceConnectListener mOnDeviceConnectListener;
...
//         * @param createNew
//         */
//        public void onConnect(UsbDevice device, USBMonitor3.UsbControlBlock ctrlBlock, boolean createNew);
//        /**
//         * called when USB device removed or its power off (this callback is called after device closing)
//         * @param device
//         * @param ctrlBlock
//         */
//        public void onDisconnect(UsbDevice device, USBMonitor3.UsbControlBlock ctrlBlock);
//        /**
...
//    }
//
//    public USBMonitor3(final Context context, final USBMonitor3.OnDeviceConnectListener listener) {
//        if (DEBUG) Log.v(TAG, "USBMonitor3:Constructor");
//        if (listener == null)
...
//        destroyed = false;
//        if (DEBUG) Log.v(TAG, "USBMonitor3:mUsbManager=" + mUsbManager);
//    }
//
//    /**
...
//            if (keys != null) {
//                USBMonitor3.UsbControlBlock ctrlBlock;
//                try {
...
//     */
//    public USBMonitor3.UsbControlBlock openDevice(final UsbDevice device) throws SecurityException {
//        if (hasPermission(device)) {
//            USBMonitor3.UsbControlBlock result = mCtrlBlocks.get(device);
//            if (result == null) {
//                result = new USBMonitor3.UsbControlBlock(USBMonitor3.this, device);    // この中でopenDeviceする
...
//                final UsbDevice device = intent.getParcelableExtra(UsbManager.EXTRA_DEVICE);
//                if (device != null) {
//                    USBMonitor3.UsbControlBlock ctrlBlock = mCtrlBlocks.remove(device);
//                    if (ctrlBlock != null) {
//                        // cleanup
//                        ctrlBlock.close();
//                    }
...
//                if (ctrlBlock == null) {
//                    ctrlBlock = new USBMonitor3.UsbControlBlock(USBMonitor3.this, device);
...
//     * @return
//     */
//    public USBMonitor3.UsbDeviceInfo getDeviceInfo(final UsbDevice device) {
...
//     * @return
//     */
//    public static USBMonitor3.UsbDeviceInfo getDeviceInfo(final Context context, final UsbDevice device) {
//        return updateDeviceInfo((UsbManager)context.getSystemService(Context.USB_SERVICE), device, new USBMonitor3.UsbDeviceInfo());
//    }
//
//    /**
//     * ベンダー名・製品名・バージョン・シリアルを取得する
...
//     * @return
//     */
//    public static USBMonitor3.UsbDeviceInfo updateDeviceInfo(final UsbManager manager, final UsbDevice device, final USBMonitor3.UsbDeviceInfo _info) {
//        final USBMonitor3.UsbDeviceInfo info = _info != null ? _info : new USBMonitor3.UsbDeviceInfo();
//        info.clear();
//
//        if (device != null) {
...
//        private final WeakReference<USBMonitor3> mWeakMonitor;
//        private final WeakReference<UsbDevice> mWeakDevice;
//        protected UsbDeviceConnection mConnection;
//        protected final USBMonitor3.UsbDeviceInfo mInfo;
...
//         * @param device
//         */
//        private UsbControlBlock(final USBMonitor3 monitor, final UsbDevice device) {
//            if (DEBUG) Log.i(TAG, "UsbControlBlock:constructor");
//            mWeakMonitor = new WeakReference<USBMonitor3>(monitor);
...
//         * @throws IllegalStateException
//         */
//        private UsbControlBlock(final USBMonitor3.UsbControlBlock src) throws IllegalStateException {
//            final USBMonitor3 monitor = src.getUSBMonitor3();
...
//            mBusNum = src.mBusNum;
//            mDevNum = src.mDevNum;
//            // FIXME USBMonitor3.mCtrlBlocksに追加する(今はHashMapなので追加すると置き換わってしまうのでだめ, ListかHashMapにListをぶら下げる?)
//        }
//
//        /**
//         * duplicate by clone
//         * need permission
//         * USBMonitor3 never handle cloned UsbControlBlock, you should release it after using it.
//         * @return
//         * @throws CloneNotSupportedException
//         */
//        @Override
//        public USBMonitor3.UsbControlBlock clone() throws CloneNotSupportedException {
//            final USBMonitor3.UsbControlBlock ctrlblock;
//            try {
//                ctrlblock = new USBMonitor3.UsbControlBlock(this);
...
//        }
//
//        public USBMonitor3 getUSBMonitor3() {
...
//            return USBMonitor3.getDeviceKeyName(mWeakDevice.get());
//        }
//
//        /**
//         * get device key string
...
//            return USBMonitor3.getDeviceKeyName(mWeakDevice.get(), mInfo.serial, useNewAPI);
//        }
//
//        /**
//         * get device key
...
//            checkConnection();
//            return USBMonitor3.getDeviceKey(mWeakDevice.get());
//        }
//
//        /**
//         * get device key
...
//            if (useNewAPI) checkConnection();
//            return USBMonitor3.getDeviceKey(mWeakDevice.get(), mInfo.serial, useNewAPI);
//        }
//
//        /**
//         * get device key string
...
//            return USBMonitor3.getDeviceKeyName(mWeakDevice.get(), mInfo.serial, false);
//        }
//
//        /**
//         * get device key
...
//                mConnection.close();
//                mConnection = null;
//                final USBMonitor3 monitor = mWeakMonitor.get();
//                if (monitor != null) {
//                    if (monitor.mOnDeviceConnectListener != null) {
//                        monitor.mOnDeviceConnectListener.onDisconnect(mWeakDevice.get(), USBMonitor3.UsbControlBlock.this);
//                    }
...
//            if (o instanceof USBMonitor3.UsbControlBlock) {
//                final UsbDevice device = ((USBMonitor3.UsbControlBlock) o).getDevice();
